    ...
    return(<><NavBarHeader></NavBarHeader>
      ...
      <div className="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div className="row my-4">
          ...
          <ProductList products={['/images/products/Itemiser-4DX-1.jpg','/images/products/Itemiser-4DX-2.jpeg']}></ProductList>
          <br/><br/><a href="/images/productDataSheet/Itemiser_4DX - Brochure.pdf" style={{"margin":"0 auto"}} className="btn btn-primary btn-lg" download><FontAwesomeIcon icon={faDownload}  /> Download</a>
            </div>
