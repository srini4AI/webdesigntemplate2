    ...
    return(<><NavBarHeader></NavBarHeader>
      ...
      <div className="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div className="row my-4">
          ...
          <br/><a href="/images/productDataSheet/Rapiscan-632DV-Datasheet.pdf" style={{"margin":"0 auto"}} className="btn btn-primary btn-lg" download><FontAwesomeIcon icon={faDownload}  /> Download</a>
            </div>
