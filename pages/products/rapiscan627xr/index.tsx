      ...
      <div className="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div className="row my-4">
          <div className="col-lg-6 text-center">
            ...
            <img src="/images/products/Rapiscan-627XR.jpeg" className="img-fluid pt-5" alt=""/>
            <a href="/images/productDataSheet/Rapiscan-627XR-Datasheet.pdf" style={{"margin":"0 auto"}} className="btn btn-primary btn-lg" download><FontAwesomeIcon icon={faDownload}  /> Download</a>
            </div>
    ...
    <section>
        <div className="container">
            ...
            <div className="row">
              ...
              <p  className={styles.listPara}>627XR performance is in full compliance with the European Union regulations (EC) No. 300/2008, (EU) No. 2015/1998 and Commissions Decision C (2015)8005 for aviation security.</p>
              </div>
