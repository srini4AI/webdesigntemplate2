...
const rap628xr = () =>{
        ...
        <div className="container">
            ...
            <div className="row">
              ...
              <ul  className={styles.listPara}>
                <li>Target and NARCScan are designed to assist operators in the detection of a wide range of explosives and narcotics respectively in real time during the scanning process by marking a potential threat on the X-ray image. Rapiscan® Systems detection algorithms are based on regulatory material analysis techniques.</li>
              </ul>
              </div>
              <div className="col-lg-6 col-md-6 col-12">
	...
	<li>With over 13 image processing tools and detection alert algorithm functions, the feature rich software allows the operator to more easily and accurately search for contraband.</li>
            ...
            <div className="row">
              ...
              <ul  className={styles.listPara}>
                <li>628XR performance is in full compliance with the European Union regulations (EC) No. 300/2008, (EU) No. 2015/1998 and Commissions Decision C (2015)8005 for aviation security.</li>
              </ul>
              </div>
