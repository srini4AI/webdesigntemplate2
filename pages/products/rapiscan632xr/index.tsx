...
const rap632xr = () =>{
	...
	<li>With over 13 image processing tools and detection alert algorithm functions, the feature rich software allows the operator to more easily and accurately search for contraband.</li>
              ...
              <ul  className={styles.listPara}>
	<li>632XR meets the most rigorous detection and image quality requirements.</li>
</ul>
            </div>
            <div className="row">
              <div className="col-lg-6 col-md-6 col-12">
              ...
              <ul  className={styles.listPara}>
                <li>632XR performance is in full compliance with the European Union regulations (EC) No. 300/2008, (EU) No. 2015/1998 and Commissions Decision C (2015)8005 for aviation security.</li>
              </ul>
              </div>
